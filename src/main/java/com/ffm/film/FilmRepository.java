...
public class FilmRepository {
   ...
   * FilmRepository is created for the first time
   */
  @PostConstruct
  private void init() {
    ...
    film1.setId(1);
    films.put(1, film1);
    Film film2 = new Film().withFilmTitle("New Film Title 2")
        .withPosterurl("https://miro.medium.com/max/700/1*mk1-6aYaf_Bes1E3Imhc0A.jpeg")
        .withActors(actorService.getActors());
    film2.setId(2);
    films.put(2, film2);
  }
