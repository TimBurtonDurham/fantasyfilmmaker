...
public class FilmService {
  ...
  public List<Film> getFilms() {
    ...
    // films.add(new Film().withFilmTitle("New Film Title
    // 2").withPosterurl("https://miro.medium.com/max/700/1*mk1-6aYaf_Bes1E3Imhc0A.jpeg").withActors(actorService.getActors())
