...
public class Actor extends FfmEntity {
    ...
    @Override public String toString() {
        ...
        return new StringJoiner(", ", Actor.class.getSimpleName() + "[", "]").add("firstname='" + firstname + "'").add("rating=" + rating).add("lastname='" + lastname + "'")
            .add("wage=" + wage).add("hype=" + hype).add("actorimage=" + actorimage).toString();
    }
}
